    ...
    const handleStatClick = (type: string) => {
        ...
        if (type === 'documents') {
            setSelectedStat({
                ...
                title: '',
                data: [
                    { label: 'Company Documents', count: stats.company, link: '/documents/app/document', color: 'text-blue-700', bg: 'bg-blue-50', rawType: 'company' },
                    { label: 'Calibration Certificates', count: stats.calibration, link: '/documents/app/document', color: 'text-purple-700', bg: 'bg-purple-50', rawType: 'calibration' },
                    { label: 'Project Approvals', count: stats.project, link: '/documents/app/document', color: 'text-emerald-700', bg: 'bg-emerald-50', rawType: 'project' },
                    { label: 'Compliance Documents', count: stats.compliance, link: '/documents/app/document', color: 'text-rose-700', bg: 'bg-rose-50', rawType: 'compliance' }
                ]
            });
            ...
            setSelectedStat({
                ...
                title: 'Subscription',
                data: [
                    { label: 'Active (Paid)', count: subscriptions.filter(s => s.status === 'Paid').length, link: '/documents/app/subscription/all', color: 'text-green-700', bg: 'bg-green-50' },
                    { label: 'Pending Verification', count: subscriptions.filter(s => !s.status || s.status === 'Pending').length, link: '/documents/app/subscription/approval', color: 'text-amber-700', bg: 'bg-amber-50' },
                    { label: 'Approved & Processing', count: subscriptions.filter(s => s.status === 'Approved').length, link: '/documents/app/subscription/all', color: 'text-indigo-700', bg: 'bg-indigo-50' }
                ]
            });
            ...
            setSelectedStat({
                ...
                data: [
                    { label: 'Overdue (Expired)', count: documents.filter(doc => doc.needsRenewal && new Date(doc.renewalDate!) < new Date()).length, link: '/documents/app/document/renewal', color: 'text-red-700', bg: 'bg-red-50' },
                    {
                        ...
                        }).length, link: '/documents/app/document/renewal', color: 'text-orange-700', bg: 'bg-orange-50'
                    }
                ]
            });
            ...
            setSelectedStat({
                ...
                data: [
                    { label: 'New Subscription Requests', count: pendingApprovals, link: '/documents/app/subscription/approval', color: 'text-cyan-700', bg: 'bg-cyan-50' }
                ]
            });
        }
    };
