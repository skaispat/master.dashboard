...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#f8fafc] flex items-center justify-center p-4 font-sans relative overflow-hidden selection:bg-red-100 selection:text-red-900">
      ...
      <div className="w-full max-w-[850px] bg-white rounded-[2.5rem] shadow-[0_20px_60px_rgba(0,0,0,0.04)] overflow-hidden relative z-10 flex flex-col md:flex-row animate-in fade-in zoom-in-95 duration-700">
        ...
        <div className="flex-1 p-8 sm:p-12 md:p-16">
          <div className="max-w-[320px] mx-auto md:mx-0">
            ...
            <div className="mb-10">
              ...
              <p className="text-[10px] font-bold text-gray-500 mt-2 uppercase tracking-widest">Sign in to continue to SKA Ispat</p>
              <div className="h-1.5 w-10 bg-red-600 mt-4 rounded-full"></div>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              <div className="space-y-2">
                <label htmlFor="username" className="text-[10px] font-black text-gray-600 uppercase tracking-widest ml-1">Username</label>
              ...
              <div className="space-y-2">
                <label htmlFor="password" name="password-label" className="text-[10px] font-black text-gray-600 uppercase tracking-widest ml-1">Password</label>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 group-focus-within:text-red-600 transition-colors">
                    <Lock size={18} />
                  </div>
